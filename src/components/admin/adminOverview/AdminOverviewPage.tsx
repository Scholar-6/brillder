...
import BricksPlayedSidebar, { ESubjectCategory, PDateFilter } from "./OverviewSidebar";
...
class AdminOverviewPage extends Component<TeachProps, TeachState> {
          ...
          <Grid item xs={9} className="brick-row-container">
            ...
            <div className="tab-content">
              <div className="boxes-d103 margin-top-1">
                {this.renderBox(40, 'Published', true)}
                {this.renderBox(3, 'Played', true)}
                {this.renderBox(12, 'Competition Plays', false)}
                {this.renderBox(6, 'New Classes', true)}
              </div>
              <div className="boxes-d103">
                {this.renderBox(40, 'Assigned Bricks', false)}
                {this.renderBox(3, 'New Signups', true)}
