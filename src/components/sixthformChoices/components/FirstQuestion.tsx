...
class FirstQuestion extends Component<UserProfileProps, FirstQuestionProps> {
    ...
    return (
      <div className="question">
        ...
        <div className="boxes-container font-24">
          {renderCheckbox(1, "Show me A-level courses only")}
          {renderCheckbox(2, "Show me academic courses inc luding A-level and Diploma")}
          {renderCheckbox(3, "Show me vocational courses only (e.g. BTEC, T-level)")}
        ...
        <button className="absolute-contunue-btn font-25" onClick={this.props.moveNext}>Continue to Question 2</button>
