...
import ProgressBarSixthformV2 from "../sixthform/sixthformChoices/components/progressBar/ProgressBarSixthformV2";
...
class Scholar6Page extends Component<UserProfileProps, UserProfileState> {
