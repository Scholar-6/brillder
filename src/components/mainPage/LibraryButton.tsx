    ...
    return (
      <svg viewBox="0 0 163.991 148.79" className="book-svg-icon" stroke="currentColor">
        <g transform="translate(-878.008 -684)">
          ...
          <path className="third-line" d="M27,41.335V15" transform="translate(986.602 724.134)" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="6"/>
          <path className="second-line" d="M18,48.135V6" transform="translate(979.801 717.333)" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="6"/>
          <path className="first-line" d="M9 36 l 0 -42" transform="translate(973 728.668)" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="6"/>
        </g>
      </svg>
    );
  }
