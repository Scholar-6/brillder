  ...
  const renderCoverPlay = () => {
    ...
    return (
      <CoverCreditsPlay
        ...
        isPaidEducator={user?.subscriptionState === SubscriptionState.PaidTeacher || user?.subscriptionState === SubscriptionState.TeacherByAdmin}
        isCompetition={!!props.activeCompetition}
        onClick={() => {
          if (user) {
            startBrick();
          } if (onlyLibrary) {
