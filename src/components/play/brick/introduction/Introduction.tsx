          ...
          <div className="introduction-page">
            ...
            <div className="expand-title">
              ...
              <div className="arrow svgOnHover" onClick={toggleBrief}>
                <svg className="svg w100 h100 active">
                  <use href={state.briefExpanded ? sprite + "#arrow-down" : sprite + "#arrow-right"} className="text-theme-dark-blue" />
                </svg>
              </div>
            </div>
            {state.briefExpanded ? (
            ...
            <div className="expand-title">
              ...
              <div className="arrow svgOnHover" onClick={togglePrep}>
                <svg className="svg w100 h100 active">
                  <use href={state.prepExpanded ? sprite + "#arrow-down" : sprite + "#arrow-right"} className="text-theme-dark-blue" />
                </svg>
              </div>
              <span className="help-prep">Expand to start the timer. Aim to spend around {timeToSpend} minutes on this section.</span>
            </div>
            {state.prepExpanded ? (
              <div className="expanded-text">
